...
class Network:
    def __init__(self, env, args):
        ...
        self.model.add(tf.keras.layers.Dense(args.hidden_layer, activation = tf.nn.leaky_relu, input_shape = env.state_shape))
        self.model.add(tf.keras.layers.Dense(env.actions, activation = tf.nn.softmax))


        
        self.base_line = tf.keras.Sequential()
        self.base_line.add(tf.keras.layers.Dense(args.hidden_layer, activation = tf.nn.leaky_relu, input_shape = env.state_shape))
