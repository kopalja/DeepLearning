...
class Network(tf.keras.Sequential):
    ...
    def __init__(self, args):
        ...
        self.add(tf.keras.layers.Conv2D(filters=50, kernel_size=(5, 5),
                                        activity_regularizer=tf.keras.regularizers.l2(0.0002)))
        self.add(tf.keras.layers.Dropout(0.2))
        self.add(tf.keras.layers.BatchNormalization())
        self.add(tf.keras.layers.Activation(tf.nn.relu))
        self.add(tf.keras.layers.MaxPool2D())

        self.add(tf.keras.layers.Conv2D(filters=100, kernel_size=(3, 3),
                                        activity_regularizer=tf.keras.regularizers.l2(0.0002)))
        self.add(tf.keras.layers.Dropout(0.2))
        self.add(tf.keras.layers.BatchNormalization())
        self.add(tf.keras.layers.Activation(tf.nn.relu))
        ...
        self.add(tf.keras.layers.Conv2D(filters=200, kernel_size=(3, 3),
                                        activity_regularizer=tf.keras.regularizers.l2(0.0002)))
        self.add(tf.keras.layers.Dropout(0.2))
        self.add(tf.keras.layers.BatchNormalization())
        self.add(tf.keras.layers.Activation(tf.nn.relu))
        ...
        self.add(tf.keras.layers.Dense(200, activity_regularizer=tf.keras.regularizers.l2(0.0005)))
        self.add(tf.keras.layers.Dropout(0.5))
        self.add(tf.keras.layers.BatchNormalization())
        self.add(tf.keras.layers.Activation(tf.nn.relu))

        self.add(tf.keras.layers.Dense(100, activity_regularizer=tf.keras.regularizers.l2(0.0005)))
        self.add(tf.keras.layers.Dropout(0.5))
        self.add(tf.keras.layers.BatchNormalization())
        self.add(tf.keras.layers.Activation(tf.nn.relu))
