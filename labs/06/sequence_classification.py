...
class Network:
    def __init__(self, args):
        ...
        self._writer = tf.summary.create_file_writer("here", flush_millis=10 * 1000)
...
if __name__ == "__main__":
   ...
   # Parse arguments
    ...
    # args = empty()
    # args.batch_size = 16
    # args.clip_gradient = None
    # args.hidden_layer = None
    # args.epochs = 10
    # args.rnn_cell = "LSTM"
    # args.rnn_cell_dim = 10
    # args.sequence_dim = 1
    # args.sequence_length = 50
    # args.recodex = False
    # args.test_sequences = 1000
    # args.threads = 1
    # args.train_sequences = 10000
